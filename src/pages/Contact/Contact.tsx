...
const App = () => {
    ...
    return (
        ...
        <div className="min-h-screen flex justify-center items-center bg-[var(--body-bg)] p-4 sm:p-8">
            ...
            <div
                className="max-w-md w-full bg-[var(--card-bg)] rounded-xl shadow-2xl overflow-hidden p-8 space-y-6 slideInFromLeft"
            >
                <h2
                    className="text-center text-4xl font-extrabold text-[var(--text-primary)] appear" 
                >
                    {t('contact.title')}
                </h2>
                <p className="text-center text-[var(--text-muted)] appear"> 
                    {t('contact.subtitle')}
                </p>
                <form method="POST" action="#" className="space-y-6">
                    <div className="relative">
                        ...
                        />
                        <label
                            className="absolute left-0 -top-3.5 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-[var(--primary-500)] peer-focus:text-sm" 
                            htmlFor="name"
                        >
                            {t('contact.name')}
                        </label>
                    ...
                    <div className="relative pb-4"> 
                        ...
                        ></textarea>
                        <label
                            className="absolute left-0 -top-3.5 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-6 peer-focus:-top-3.5 peer-focus:text-[var(--primary-500)] peer-focus:text-sm"
                            htmlFor="message" 
                        >
                            {t('contact.message')}
                        </label>
